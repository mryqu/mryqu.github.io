...
通过[[OpenUI5] jQuery.sap.declare源码分析](/2015/08/23/[OpenUI5]jQuery.sap.declare源码分析)里介绍过的declareModule函数宣称当前模块已存在，通过[[OpenUI5] jQuery.sap.require源码分析](/2015/08/22/[OpenUI5]jQuery.sap.require源码分析)里介绍过的requireModule函数解析当前模块的每一个依赖。
```
...
[[OpenUI5] jQuery.sap.require源码分析](/2015/08/22/[OpenUI5]jQuery.sap.require源码分析/)  
[[OpenUI5] jQuery.sap.declare源码分析](/2015/08/23/[OpenUI5]jQuery.sap.declare源码分析/)  