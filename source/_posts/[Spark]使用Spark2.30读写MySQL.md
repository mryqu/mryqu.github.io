...
本博文是[[Spark] 使用Spark2.30读写Hive2.3.3](/2018/07/03/[Spark]使用Spark2.30读写Hive2.3.3)的姊妹篇，环境及Java项目也是使用上一博文中的。
...
[[Spark] 使用Spark2.30读写Hive2.3.3](/2018/07/03/[Spark]使用Spark2.30读写Hive2.3.3)  