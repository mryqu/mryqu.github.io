...
![[Spring Data] 调试H2数据库](/content/images/2015/6/0026uWfMzy769goUOCC22.jpg)
![[Spring Data] 调试H2数据库](/content/images/2015/6/0026uWfMzy769gpdKYmbe.jpg)
![[Spring Data] 调试H2数据库](/content/images/2015/6/0026uWfMzy769gpWTbUbe.jpg)

### 配置IDEA IntelliJ数据源

如果不使用H2 Web控制台的话，在IDEA IntelliJ集成开发环境中也可以通过配置H2数据源进行数据库操作。
![[Spring Data] 调试H2数据库](/content/images/2015/6/0026uWfMzy769gGJCWg2c.png)
![[Spring Data] 调试H2数据库](/content/images/2015/6/0026uWfMzy769hRntus8c.jpg)
![[Spring Data] 调试H2数据库](/content/images/2015/6/0026uWfMzy769hRANbDe5.jpg)
...
```
![[Spring Data] 调试H2数据库](/content/images/2015/6/0026uWfMzy769mHXIyV7d.jpg)
搞定，收工！
