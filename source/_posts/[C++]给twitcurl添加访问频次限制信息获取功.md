...
在我之前的博文[Twitter API访问频次限制处理](/2015/11/10/Twitter API访问频次限制处理)中，描述了Twitter API访问频次限制及Twitter4J对其处理。[twitcurl](https://github.com/mryqu/twitcurl)项目并没有这样的功能，今天我将getLastRateLimitStatus功能添加到了[twitcurl](https://github.com/mryqu/twitcurl)。
通过添加如下代码，我可以获取响应头信息：
```
