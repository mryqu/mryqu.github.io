...
![社交网络分析：社区结构](/content/images/2014/11/0026uWfMgy6OcAWTGdD5d.png)
...
![社交网络分析：社区结构](/content/images/2014/11/0026uWfMgy6OcEOte1Jdb.png)
...
![社交网络分析：社区结构](/content/images/2014/11/0026uWfMgy6OcIiSQDB57.png)
即使如此，对于识别自然社区还是过于严苛的要求。
![社交网络分析：社区结构](/content/images/2014/11/0026uWfMgy6OcIt17abdb.png)

### n – cliques

基于可达性和直径进行子组划分。子组内每两个节点最大距离为n。
![社交网络分析：社区结构](/content/images/2014/11/0026uWfMgy6OdteGeRH69.png)
问题：
- 直径可能大于n
- n-clique可能是断开的(路径通过子组外的节点进行)

![社交网络分析：社区结构](/content/images/2014/11/0026uWfMgy6OdvlXQse7e.png)
解决方法：n-club:直径2的最大子图    {1,2,3,4},{1,2,3,5} and {2,3,4,5,6}

### p-cliques

将网络分割成子组，其中节点至少有概率p的邻居节点在子组内。
![社交网络分析：社区结构](/content/images/2014/11/0026uWfMgy6Odw7agZ86e.png)
...
![社交网络分析：社区结构](/content/images/2014/11/0026uWfMgy6Odyz8fGS8e.png)
...
![社交网络分析：社区结构](/content/images/2014/11/0026uWfMgy6OdyMKz5F7b.jpg)

### 模块度（Modularity）

考虑了社区内的边和社区与网络其他部分之间的边
模块度定义：
![社交网络分析：社区结构](/content/images/2014/11/0026uWfMgy6OdI4OSWu72.jpg)
