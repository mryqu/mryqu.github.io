...
用pstree命令查看一下ID为1的进程，原来是init：![在Ubuntu中识别当前Init系统](/content/images/2016/8/0026uWfMzy759cAy8UU58.png) 可以下面几个命令查看init进程所用的命令信息：
- ps -efa|grep init
- type init
- sudo stat /proc/1/exe

最终通过"sudo init --version"可知当前的Init系统为upstart：![在Ubuntu中识别当前Init系统](/content/images/2016/8/0026uWfMzy759d8PJcKd2.jpg)
...
```
用pstree命令查看一下ID为1的进程，原来是systemd：![在Ubuntu中识别当前Init系统](/content/images/2016/8/0026uWfMzy75azKHvSWf2.jpg)
