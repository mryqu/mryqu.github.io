...
![Exuberant Ctags笔记](/content/images/2013/10/0026uWfMgy6XETkbkcod8.png)
...
- `--list−maps`：显示文件名和语言的映射
  ![Exuberant Ctags笔记](/content/images/2013/10/0026uWfMgy6XF0sgjTBc3.png)
- `--list−languanges`：显示所有支持的语言
  ![Exuberant Ctags笔记](/content/images/2013/10/0026uWfMgy6XF0zDJDeec.png)
- `--langmap`：设置文件名和语言的映射
  如果程序中有的.c文件其实是C++程序，这该怎么办？答案是使用ctags --langmap=c++:+.c。![Exuberant Ctags笔记](/content/images/2013/10/0026uWfMgy6XF2jJyVqb8.png)
