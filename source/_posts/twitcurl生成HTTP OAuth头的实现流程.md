...
- 通过getSignature( eType, pureUrl, rawKeyValuePairs,oauthSignature );获得签名
  - 生成 sigBase：![twitcurl生成HTTP OAuth头的实现流程](/content/images/2015/12/0026uWfMzy72R7B4EEcec.png)
  ...
  - 通过百分比编码获得最终签名：![twitcurl生成HTTP OAuth头的实现流程](/content/images/2015/12/0026uWfMzy72RbbH8DFf3.png) (非真实计算而得数据)
...
- 最终生成HTTP授权头：![twitcurl生成HTTP OAuth头的实现流程](/content/images/2015/12/0026uWfMzy72RbQrAEb93.png)
