...
此外，也可以使用下列GUI工具：
- aptitude：Debian GNU/Linux包系统基于文本的界面接口。![Debian软件包管理速查表：dpkg、apt-get、apt-cache](/content/images/2013/10/0026uWfMgy6VWKqNWlv75.jpg)
- synaptic：APT的前端基于图形的界面接口。![Debian软件包管理速查表：dpkg、apt-get、apt-cache](/content/images/2013/10/0026uWfMgy6VWKs2ggh21.jpg)
