...
- 通信
---
昨天发了一个帖子[[OpenUI5] MVC：访问其他View/Controller的方法](/2015/01/08/[OpenUI5]MVC：访问其他View或Controller的方法)，里面的示例是用违反MVC原则的方式演示一下效果，今天又在jsbin上做了个OpenUI5MVC & EventBus示例：[http://jsbin.com/nixomo/1/edit?html,output](http://jsbin.com/nixomo/1/edit?html,output)。
...
![[OpenUI5] MVC和EventBus示例](/content/images/2015/1/0026uWfMgy6P2x0uJs874.jpg)
