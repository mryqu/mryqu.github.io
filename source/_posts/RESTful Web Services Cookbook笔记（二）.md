...
...
```
服务器处理条件PUT请求 ![RESTful Web Services Cookbook笔记（二）](/content/images/2013/10/0026uWfMty6FiLFRZ0R31.png)
服务器处理条件DELETE请求 ![RESTful Web Services Cookbook笔记（二）](/content/images/2013/10/0026uWfMty6FiLGJNAxf5.png)
