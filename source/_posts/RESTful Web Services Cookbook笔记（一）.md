...
href既可以是绝对URI也可以是相对URI（需要在link元素中包含xml:base属性）。![RESTful Web Services Cookbook笔记（一）](/content/images/2013/10/0026uWfMgy6RTyZ9Mdr89.png)
...
- 当客户端/服务器软件需要不解析表述体添加或读取链接。![RESTful Web Services Cookbook笔记（一）](/content/images/2013/10/0026uWfMgy6RTzi8xop2d.png)
