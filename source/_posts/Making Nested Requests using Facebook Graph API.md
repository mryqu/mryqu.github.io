...
```
![FB:SASSoftware feed](/content/images/2017/04/FB_SASSoftware_feed.png)
...
```
![FB:SASSoftware pageItemComment](/content/images/2017/04/FB_SASSoftware_pageItemComment.png)
...
```
![FB:SASSoftware pageItemCommentReply](/content/images/2017/04/FB_SASSoftware_pageItemCommentReply.png)
### 试用嵌套请求
```
...
![FB:SASSoftware restedRequest](/content/images/2017/04/FB_SASSoftware_restedRequest.png)
