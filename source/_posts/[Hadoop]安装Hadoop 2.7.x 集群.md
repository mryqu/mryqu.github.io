...
参见之前的博文[在Ubuntu中禁掉IPv6](/2015/03/20/在Ubuntu中禁掉IPv6)。
...
![[Hadoop] 安装Hadoop 2.7.x 集群](/content/images/2015/4/0026uWfMzy76BZ6yRcSe2.png)
...
![[Hadoop] 安装Hadoop 2.7.x 集群](/content/images/2015/4/0026uWfMzy76B85fvBa94.png)
...
![[Hadoop] 安装Hadoop 2.7.x 集群](/content/images/2015/4/0026uWfMzy76DUDTmf577.png)
#### etc/hadoop/[hdfs-site.xml](http://hadoop.apache.org/docs/r2.7.0/hadoop-project-dist/hadoop-hdfs/hdfs-default.xml)
![[Hadoop] 安装Hadoop 2.7.x 集群](/content/images/2015/4/0026uWfMzy76DVmBX81b5.png)
#### etc/hadoop/[yarn-site.xml](https://hadoop.apache.org/docs/r2.7.0/hadoop-yarn/hadoop-yarn-common/yarn-default.xml)
![[Hadoop] 安装Hadoop 2.7.x 集群](/content/images/2015/4/0026uWfMzy76F4xpqR147.png)
...
![[Hadoop] 安装Hadoop 2.7.x 集群](/content/images/2015/4/0026uWfMzy76F4P3xeLef.png)
#### etc/hadoop/masters
```
node50064
```
...
#### 查看JVM进程状态
![[Hadoop] 安装Hadoop 2.7.x 集群](/content/images/2015/4/0026uWfMzy76F5JEmY313.png)
#### 运行Hadoop范例
```
hdfs dfs -mkdir /user
...
#### 查看HDFS Web UI
![[Hadoop] 安装Hadoop 2.7.x 集群](/content/images/2015/4/0026uWfMzy76F8fa5t5ff.jpg)
#### 查看YARN资管管理器Web UI
![[Hadoop] 安装Hadoop 2.7.x 集群](/content/images/2015/4/0026uWfMzy76F8CYxRA3e.jpg)
#### 查看MapReduce作业历史
![[Hadoop] 安装Hadoop 2.7.x 集群](/content/images/2015/4/0026uWfMzy76F8NtoZ694.jpg)
