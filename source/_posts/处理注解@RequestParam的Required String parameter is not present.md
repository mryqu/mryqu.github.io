...
```
访问http://localhost:8080/hellorest/test.do 时发生如下问题：![处理注解@RequestParam的"Required String parameter is not present"](/content/images/2014/2/0026uWfMgy6MJkj4sBC5c.jpg)
