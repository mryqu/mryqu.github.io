...
- 完成OpenSSL配置，仅支持静态库不支持动态库：
    ...
    ```
- 对Makefile文件中的FGLAG和DEPFLAG变量进行修改，增加-fPIC。![[C++] 编译OpenSSL和libCurl](/content/images/2015/3/0026uWfMzy7bGLedy9Q82.jpg)
- 编译：
   ```
   make depend
   make
...
编译产生如下内容：
![[C++] 编译OpenSSL和libCurl](/content/images/2015/3/0026uWfMzy7bGLgoaR967.png)
...
编译产生如下内容：
![[C++] 编译OpenSSL和libCurl](/content/images/2015/3/0026uWfMzy7bGLhhT6h09.png)
