...
---
### 获取Facebook主页Id
https://graph.facebook.com/v2.5/SasSoftware?access_token={accessToken}&format=json ![Facebook Graph API之我的常用URL笔记](/content/images/2016/1/0026uWfMgy71y27IyKe8a.png)上面示例是通过主页名SasSoftware获取其主页Id。
### 获取Facebook主页帖子
