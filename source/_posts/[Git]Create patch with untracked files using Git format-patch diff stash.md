...
![[Git] Create patch with untracked files using Git format-patch/diff/stash](/content/images/2015/1/0026uWfMgy6PvD6KZIW26.png) "git diff" is used for unstaged changes, "gitdiff --cached" is used for staged changes, neither includeuntracked files.

### Try stash

![[Git] Create patch with untracked files using Git format-patch/diff/stash](/content/images/2015/1/0026uWfMgy6PvD8qEm90d.png)The above "git stash" and "git show" commands can satisfy the requirement.
