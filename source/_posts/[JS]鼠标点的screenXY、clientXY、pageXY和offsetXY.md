...
* pageX/Y：鼠标点相对浏览器所有渲染内容区域（viewport）左上角的偏移量。(滚动后，文档左上角有可能不在浏览器窗口中，仍旧从文档左上角算起)  
  ![MousePoint](/content/images/2018/01/MousePoint_PageAndClient.png)
  桌面浏览器基本支持，移动浏览器有可能不支持。
...
![MousePoint Code](/content/images/2018/01/MousePoint_code.png)

### 测试

![MousePoint Test](/content/images/2018/01/MousePoint_test.png)
