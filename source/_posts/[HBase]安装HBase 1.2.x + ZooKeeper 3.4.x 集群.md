...
本文采用第一种方式。
#### conf/hbase-site.xml
![[HBase] 安装HBase 1.2.x + ZooKeeper 3.4.x 集群](/content/images/2016/2/0026uWfMzy76JbHNJI76b.jpg)
#### conf/regionservers
```
node50069.mryqu.com
node51054.mryqu.com
...
步骤详见之前的博文[[Hadoop] 安装Hadoop 2.7.x 集群](/2015/04/28/[Hadoop]安装Hadoop 2.7.x 集群)。
...
#### 查看JVM进程状态
![[HBase] 安装HBase 1.2.x + ZooKeeper 3.4.x 集群](/content/images/2016/2/0026uWfMzy76NwM8Ft1ab.png)
#### 测试HBase Shell
![[HBase] 安装HBase 1.2.x + ZooKeeper 3.4.x 集群](/content/images/2016/2/0026uWfMzy76NQCsehYd2.jpg)
#### 查看HBase Master web UI
![[HBase] 安装HBase 1.2.x + ZooKeeper 3.4.x 集群](/content/images/2016/2/0026uWfMzy76NR8vyaU54.jpg)![[HBase] 安装HBase 1.2.x + ZooKeeper 3.4.x 集群](/content/images/2016/2/0026uWfMzy76NRwkBHl13.jpg)
#### 查看HBase RegionServer web UI
![[HBase] 安装HBase 1.2.x + ZooKeeper 3.4.x 集群](/content/images/2016/2/0026uWfMzy76NRODvCT6f.jpg)![[HBase] 安装HBase 1.2.x + ZooKeeper 3.4.x 集群](/content/images/2016/2/0026uWfMzy76NRYCjOIc4.jpg)
#### 使用命令查看ZooKeeper信息
![[HBase] 安装HBase 1.2.x + ZooKeeper 3.4.x 集群](/content/images/2016/2/0026uWfMzy76NWIq5m860.png)
