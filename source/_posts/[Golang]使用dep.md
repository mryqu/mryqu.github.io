...
之前的博文[[Golang]Win10下Glide的安装和使用](/2017/10/16/[Golang]Win10下Glide的安装和使用)记录了对Glide的学习，本博将记录对Golang包管理工具dep的学习使用。
...
仍然使用博文[[Golang]Win10下Glide的安装和使用](/2017/10/16/[Golang]Win10下Glide的安装和使用)中的源码示例：
```
package main
