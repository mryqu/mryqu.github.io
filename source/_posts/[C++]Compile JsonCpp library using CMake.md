...
```
![Linux: gcc version](/content/images/2017/03/gccVer.png)
#### 升级cmake
...
```
![Linux: cmake version](/content/images/2017/03/cmakeLinuxVer.png)
#### 编译[JsonCpp](https://github.com/open-source-parsers/jsoncpp/)
```
cmake -DCMAKE_BUILD_TYPE=release -DBUILD_STATIC_LIBS=ON -DBUILD_SHARED_LIBS=OFF -DARCHIVE_INSTALL_DIR=. -G "Unix Makefiles" ../..
make
```
![Linux: build jsoncpp](/content/images/2017/03/jsoncppLinuxBuild.png)
### Windows平台

#### 准备环境
首先下载[JsonCpp](https://github.com/open-source-parsers/jsoncpp/) 1.8.0源码，并解压缩。我的机器已经部署了VS2013和CMake。
![Windows: cmake version](/content/images/2017/03/cmakeWinVer.png)
#### 编译[JsonCpp](https://github.com/open-source-parsers/jsoncpp/)
```
cmake -DBUILD_STATIC_LIBS=ON -DBUILD_SHARED_LIBS=OFF -G "Visual Studio 12 2013 Win64" ..
cmake --build . --config Release
```
![Windows: cmake GenBuildFile](/content/images/2017/03/cmakeWinGenBuildFile.png) ![Windows: build jsoncpp](/content/images/2017/03/jsoncppWinBuild.png) ![Windows: check lib](/content/images/2017/03/checkWinJsoncppLib.png)
