...
为了便于开发和测试，为控件设置一个便于理解的ID尤为重要。我的博文[《快速定位OpenUI5问题的一个方法》](/2015/01/09/[OpenUI5]快速定位OpenUI5问题的一个方法)中的工具函数就是利用控件ID快速定位故障控件的。
...
![[OpenUI5] 控件ID实践与总结](/content/images/2015/5/0026uWfMgy6So69EaqV3d.png)
...
![[OpenUI5] 控件ID实践与总结](/content/images/2015/5/0026uWfMgy6Sob9sBPu5c.jpg)
图像相应的DOM输出为：
![[OpenUI5] 控件ID实践与总结](/content/images/2015/5/0026uWfMgy6SobcxAAlb5.png)
