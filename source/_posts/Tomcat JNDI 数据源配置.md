...
- Tomcat全局命名空间
  ...
  ![Tomcat:JNDI数据源配置](/content/images/2012/8/0026uWfMgy6OTI3IELI3e.jpg)
  $CATALINA_HOME$/conf/localhost/javatest.xml
  ![Tomcat:JNDI数据源配置](/content/images/2012/8/0026uWfMgy6OTIlpNN46e.png)
- Web应用程序环境(Context)![Tomcat:JNDI数据源配置](/content/images/2012/8/0026uWfMgy6OTIx4xLj29.jpg)