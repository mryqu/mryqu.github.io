...
![Spark Catalog ListFunctions](/content/images/2018/07/spark_catalog_listfunctions.png)按照以前的博文[[Hive] Hive Macro和UDF实践](/2015/08/18/[Hive]Hive Macro和UDF实践)创建持久性函数my_hello和my_lower后，使用Catalog API查询：
```
