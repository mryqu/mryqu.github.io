...
![了解用于Gerrit代码审查的GitHub插件](/content/images/2015/5/0026uWfMzy74lUxvpRfa1.jpg)

#### GitHub BitBucket GitLab Gitorious阵营

这一派的PULL REQUEST基于两个分支的合并，注释可能会乱一点，有点惹人烦。不考虑将所有原子/相关修改作为一个提交。除了写注释无法知道审查打分情况。
![了解用于Gerrit代码审查的GitHub插件](/content/images/2015/5/0026uWfMzy74lUGLnyz23.jpg)

#### Gerrit GitBlit阵营

这一派的每个提交有其审查结果，可以清晰查看以往历史。Gerrit审查可以强制成仅接受快进（fast-worward）或可rebase的提交。
![了解用于Gerrit代码审查的GitHub插件](/content/images/2015/5/0026uWfMzy74lUKsQLQa6.jpg)
...
![了解用于Gerrit代码审查的GitHub插件](/content/images/2015/5/0026uWfMzy74qLgVFgT93.jpg)

#### 第二步：获取Client ID和Client Secret

![了解用于Gerrit代码审查的GitHub插件](/content/images/2015/5/0026uWfMzy74mqawTJOd4.jpg)
...
![了解用于Gerrit代码审查的GitHub插件](/content/images/2015/5/0026uWfMzy74qFyY3AI90.png)
使用Git Bash启动Gerrit。
![了解用于Gerrit代码审查的GitHub插件](/content/images/2015/5/0026uWfMzy74qFz6GNC0c.jpg)
登陆后，可以查看到当前安装的插件。
![了解用于Gerrit代码审查的GitHub插件](/content/images/2015/5/0026uWfMzy74qFzdYJI2a.jpg)
...
![了解用于Gerrit代码审查的GitHub插件](/content/images/2015/5/0026uWfMzy74qG30Yx765.jpg)

#### 第六步：重新配置Gerrit

![了解用于Gerrit代码审查的GitHub插件](/content/images/2015/5/0026uWfMzy74qKUMmEcd4.jpg)

#### 第七步：完成GitHub认证

![了解用于Gerrit代码审查的GitHub插件](/content/images/2015/5/0026uWfMzy74qKUUxlA3e.png)![了解用于Gerrit代码审查的GitHub插件](/content/images/2015/5/0026uWfMzy74qKV6YKV6d.jpg)![了解用于Gerrit代码审查的GitHub插件](/content/images/2015/5/0026uWfMzy74qKVi2YD77.png)
