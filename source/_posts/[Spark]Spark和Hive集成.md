...
- spark-sql
---
在前一博文[[Spark] Spark2集群安装实践](/2016/07/28/[Spark]Spark2集群安装实践)中安装了Spark后，发现和Hive还没有集成在一起，此外Hive自己也不好使了。
```
...
- Spark SQL CLI需要使用到Hive Metastore，因此需要在[[Hive] 安装Hive 1.2.x](/2015/07/24/[Hive]安装Hive 1.2.x)的基础上继续修改$HIVE_HOME/conf/hive-site.xml：![[Spark]Spark和Hive集成](/content/images/2016/8/0026uWfMzy7lNfbiHfn65.jpg)
