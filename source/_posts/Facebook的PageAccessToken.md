...
注：我的App yquTest当前App版本为2.8。![failedAppAccessToken](/content/images/2018/10/failedAppAccessToken.png) 
祭出Access Token Tool武器，开始实验User Access Token。
![FacebookAccessTokenTool](/content/images/2018/10/FacebookAccessTokenTool.png)
发现结果如下：
...
![MutliPageAccessToken](/content/images/2018/10/MutliPageAccessToken.png)
#### 获取自己单个主页的Page Access Toke
![SinglePageAccessToken](/content/images/2018/10/SinglePageAccessToken.png)
#### 使用Page Access Token获取自己的主页内容
![UsePageAccessToken](/content/images/2018/10/UsePageAccessToken.png)
#### 尝试获取他人主页的Page Access Token
![NeedPagePublicContentAccessFeature](/content/images/2018/10/NeedPagePublicContentAccessFeature.png)
结果自然是嘿嘿嘿。
#### 结论
