...
![获取Facebook App Token](/content/images/2015/10/0026uWfMzy73W7olg5u8c.jpg)
通过其App Id和App Secret进行实验，获得结果可以用上一篇博文[Facebook开发调试工具](/2015/10/07/Facebook开发调试工具)提到的访问口令工具验证，完全一致！
