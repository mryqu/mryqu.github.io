...
以test.cpp为例：![Linux/Unix下显示二进制目标文件的符号表](/content/images/2013/10/0026uWfMgy6YLylTfgJ61.png)
将其编译后，通过nm查看符号表，带"-C"选项与否的结果如下：![Linux/Unix下显示二进制目标文件的符号表](/content/images/2013/10/0026uWfMgy6YLyG1SuB59.jpg)
...
显示test.o的elf文件头信息：![Linux/Unix下显示二进制目标文件的符号表](/content/images/2013/10/0026uWfMgy6YLKopZKie2.png)
显示test.o的符号表：![Linux/Unix下显示二进制目标文件的符号表](/content/images/2013/10/0026uWfMgy6YLKCrkDG74.jpg)
