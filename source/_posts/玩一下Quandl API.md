...
![Quandl queryDataset](/content/images/2017/05/Quandl_queryDataset.png)
...
*   获取表元数据  
    ...
    ```
    ![Quandl getDatatableMeta](/content/images/2017/05/Quandl_getDatatableMeta.png)
...
*   获取表数据  
    ...
    ```
    ![Quandl getDatatable](/content/images/2017/05/Quandl_getDatatable.png)
...
导出PRICES全表：  
![Quandl exportDatatable](/content/images/2017/05/Quandl_exportDatatable.png)
过滤mapcode为-5370、compnumber为39102且reporttype为A的行，输出表的reportdate和amount列：  
![Quandl queryDatatable](/content/images/2017/05/Quandl_queryDatatable.png)
