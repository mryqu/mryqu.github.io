...
- 示例
---
即前一博文[[Hadoop] 通过MultipleInputs处理多输入文件](/2014/09/29/[Hadoop]通过MultipleInputs处理多输入文件)展示如何处理MapReduce多输入问题，本文将展示一下如何处理MapReduce多输出的方法。

### MultipleOutputs示例

#### MultipleOutputsDemo.java源码

![[Hadoop] 通过MultipleOutputs生成多输出文件](/content/images/2014/9/0026uWfMzy79EaCfa4M78.jpg)
...
![[Hadoop] 通过MultipleOutputs生成多输出文件](/content/images/2014/9/0026uWfMzy79E9QCUVp37.jpg)
