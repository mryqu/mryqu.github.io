...
```
![libcurl: CURLOPT_VERBOSE](/content/images/2016/12/libcurl-CURLOPT_VERBOSE.png)这样就可以看到请求报头、响应报头和消息体了。
#### 使用CURLOPT_DEBUGFUNCTION
使用libcurl API指南中[CURLOPT_DEBUGFUNCTION](https://curl.haxx.se/libcurl/c/CURLOPT_DEBUGFUNCTION.html)示例代码即可。![libcurl: CURLOPT_DEBUGFUNCTION](/content/images/2016/12/libcurl-CURLOPT_DEBUGFUNCTION.png)这样就可以看到完整的请求和响应内容了。
