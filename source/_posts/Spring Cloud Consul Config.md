...
![Spring Cloud Consul](/content/images/2017/06/SpringCloudConsul.png)

### 安装并启动Consul

每个集群需要最少三台Consul server，以建立仲裁(quorum)，每个机器上必须运行一个consul agent。
![Consul Environment](/content/images/2017/06/ConsulEnv.png)
...
![Dependencies Specified By BOM](/content/images/2017/06/DependenciesSpecifiedByBOM.png)
...
![Consul KV Store](/content/images/2017/06/ConsulKVStore.png)

### 测试

#### 服务注册
当对consul-config-demo执行完gradle bootrun命令后，即可在Consul UI上看到注册的consul-config-demo服务了。
![Consul Services](/content/images/2017/06/ConsulServices.png)
#### 健康检查
Spring Cloud Consul对Spring Boot应用的健康检查是借助Spring Boot Actuator完成的。
![Consul Health Check](/content/images/2017/06/ConsulHealthCheck.png)
#### 服务测试
![Spring Cloud Consul Test](/content/images/2017/06/SpringCloudConsulTest.png)
