...
![[Hive] Hive表文件存储格式](/content/images/2015/8/0026uWfMzy78d0KTye85c.png)
在我的环境下，按照压缩的Sequence File格式存储后的文件是非压缩的。
![[Hive] Hive表文件存储格式](/content/images/2015/8/0026uWfMzy78cRQJQSm32.png)

#### 获取ORC文件信息

![[Hive] Hive表文件存储格式](/content/images/2015/8/0026uWfMzy78bBBaxLu24.jpg)
