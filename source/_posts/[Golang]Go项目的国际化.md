...
具体细节见之前的博文[Go程序内嵌I18N properties文件](/2017/10/19/[Golang]Go程序内嵌I18N properties文件)。  
...
与之前的博文[Go程序内嵌I18N properties文件](/2017/10/19/[Golang]Go程序内嵌I18N properties文件)相比，这里添加了下面内容：
...
更多细节见之前的博文[使用Makefile实现Go项目的跨平台构建](/2017/10/18/[Golang]使用Makefile实现Go项目的跨平台构建) 。这里在setup规则里增加了glide update，增加了generate规则。
```
