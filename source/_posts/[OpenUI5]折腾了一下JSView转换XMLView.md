...
采用我之前的博文[[OpenUI5] MVC和EventBus示例](/2015/01/09/[OpenUI5]MVC和EventBus示例)中的示例做一下实验：
首先打开SAPUI5 Diagnostics，在Control Tree中选择一个JSView：![Openui5 Diagnostics](/content/images/2017/02/Openui5_Diagnostics.png)
看到Export to XML按钮了：![Openui5 Diagnostics ExportToXml](/content/images/2017/02/Openui5_Diagnostics_ExportToXml.png)
悲剧了，无法导出，说什么p.indexOfContent is not a function：![Openui5 Diagnostics ExportToXml error](/content/images/2017/02/Openui5_Diagnostics_ExportToXml_Error.png)
...
开始用Chrome Dev Tool调试，不用点击按钮就可以触发转换了：![Openui5 Diagnostics ExportToXml debug error](/content/images/2017/02/Openui5_Diagnostics_ExportToXml_debugError.png)
再进一步替换成如下代码：
```
var o = 
{
