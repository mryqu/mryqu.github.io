...
![原始博客页面](/content/images/2018/07/original_githubio.png)
...
![Disqus页面](/content/images/2018/07/disqus.png)
...
- hexo server或hexo s: 启动本地服务器，默认为http://localhost:4000/
- hexo deploy或hexo d: 提交到GitHub上
- hexo s -g: 生成静态文件并启动本地服务器
- hexo d -g: 生成静态文件并提交到GitHub上

新界面如下所示，大功告成！
![新博客页面](/content/images/2018/07/new_githubio.png)
