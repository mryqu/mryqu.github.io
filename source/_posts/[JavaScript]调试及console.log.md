...
- 调试
---
最近玩一下javascipt，在回调里碰到一个问题，需要调试。加入了console.log函数打印日志，在我的chrome浏览器按Ctrl+Shift+J快捷键调出DevTool并显示控制台来查找问题。![javascript: 调试及console.log](/content/images/2013/12/0026uWfMgy6K0PpadIqd6.jpg)
结合Wireshark，最后才发现对Json数据解析错误。![javascript: 调试及console.log](/content/images/2013/12/0026uWfMgy6K0Tsvyifdb.jpg)
