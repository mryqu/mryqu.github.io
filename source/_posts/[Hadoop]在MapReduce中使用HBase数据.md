...
![[Hadoop] 在MapReduce中使用HBase数据](/content/images/2014/5/0026uWfMzy792BlMwdae0.jpg)
### rebuild.sh
```
#!/bin/bash
...
HBase结果如下:
![[Hadoop] 在MapReduce中使用HBase数据](/content/images/2014/5/0026uWfMzy792yZMSQq9a.png)
...
- 本例中ScoreReducer类继承自抽象类TableReducer。TableReducer是Reduccer抽象类的子类，指定输出值类型为Mutation。因此ScoreReducer定义仅指定输入键和值、输出键的类型。有下图可知，TableReducer输出值类型支持Append、Delete、Increment和Put。![[Hadoop] 在MapReduce中使用HBase数据](/content/images/2014/5/0026uWfMzy79wvqMf45f9.png)
