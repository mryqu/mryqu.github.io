...
ROW FORMAT DELIMITED 
  ...
  LINES  TERMINATED BY '\n';
```
![[Hive] Hive数据类型](/content/images/2015/8/0026uWfMzy78eDRctpk26.png)
...
```
![[Hive] Hive数据类型](/content/images/2015/8/0026uWfMzy78eExH4Ne34.png)
```
...
下面我们直接在Hive表放置文件数据。
![[Hive] Hive数据类型](/content/images/2015/8/0026uWfMzy78eHEoFCWf2.png)
...
![[Hive] Hive数据类型](/content/images/2015/8/0026uWfMzy78eNqN7Jc86.png)
...
结果如下：
![[Hive] Hive数据类型](/content/images/2015/8/0026uWfMzy78eOHfGSJ61.png)

以下是我的体会：
- 在对struct插值时，仅在列名为col1、col2...时可以使用struct UDF，否则必须使用named_structUDF。![[Hive] Hive数据类型](/content/images/2015/8/0026uWfMzy78ePhOxQQf0.png)
- 在对union插值时，必须用tag选择用那个类型，在我的示例里：0-INT，1-BOOLEAN，2-STRING，这个tag下标不能越界。三个类型的值也必须存在，否则插入失败。![[Hive] Hive数据类型](/content/images/2015/8/0026uWfMzy78ePV8pn86e.png)
...
[Hive UDF not supported in insert/values command](/2015/08/10/[Hive]Hive%20UDF%20not%20supported%20in%20insertvalues%20command/)  
