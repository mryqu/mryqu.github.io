...
1. 进入Zeppelin UI，点击“Create new note”创建新的笔记，名字叫Spark Sample。  
   ![zeppellin new note](/content/images/2018/07/zeppellin_newnote.jpg)
2. 将测试文件放到hdfs集群上：  
   ```
...
3. 执行下列修改过的Zeppelin指南示例代码：  
    ...
    ```
    ![zeppellin graph sample](/content/images/2018/07/zeppelin_graphsamp.jpg)数据分析结果可以以表、条形图、饼图、面积图、曲线图、散点图的形式表现。
