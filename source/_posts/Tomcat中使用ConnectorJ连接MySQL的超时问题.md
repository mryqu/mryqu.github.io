...
最后决定采用如下方案：
#### hibernate增加如下设置:
![Tomcat中使用Connector/J连接MySQL的超时问题](/content/images/2014/5/0026uWfMzy6OK64J81K24.png)
#### 数据库连接池增加如下设置:
![Tomcat中使用Connector/J连接MySQL的超时问题](/content/images/2014/5/0026uWfMzy6OK5XM1ABf1.png)