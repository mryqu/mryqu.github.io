...
1. 在Google开发者控制台中确认Analytics API已经使能
   ![enable Analytics API](/content/images/2015/9/0026uWfMgy6WclsRaWLdb.jpg)
2. Service account的邮箱域为@developer.gserviceaccount.com
   ![Service account mail domain](/content/images/2015/9/0026uWfMgy6WcltfPYi1e.jpg)
3. 拥有适当的AccountID和ProfileID，并将serviceaccount（至少以读取和分析权限）添加到Google Analytics profile
   ![enable premit](/content/images/2015/9/0026uWfMgy6WcltLBDEe6.jpg)
