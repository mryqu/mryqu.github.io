...
#### 安装CTags插件
- 通过 Preference -> Package Control -> InstallPackage安装Ctags插件（快捷键Ctrl+Shift+P，输入install）![Sublime Text2+Ctags+Cscope使用实践](/content/images/2015/12/0026uWfMgy71ddMtNSZ4d.jpg)
...
- 打开C工程根目录，在上点击右键，选择Ctags:Rebuild tags![Sublime Text2+Ctags+Cscope使用实践](/content/images/2015/12/0026uWfMgy71dei8odx87.png)
...
- Ctrl + \ - Show Cscope options![Sublime Text2+Ctags+Cscope使用实践](/content/images/2015/12/0026uWfMgy71dj5dhrB3b.png)
...
[Exuberant Ctags笔记](/2013/10/19/Exuberant Ctags笔记)    
[Cscope笔记](/2013/10/19/Cscope笔记)    