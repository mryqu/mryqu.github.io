...
[获取Facebook App Token](/2015/10/08/获取Facebook App Token)一贴中已经介绍了如何获取Facebook App Token，这里就介绍一下如何获取UserToken。
...
![获取Facebook User Token](/content/images/2016/8/0026uWfMzy73WsVvBVv99.jpg)[Facebook Login - Advance - Manually Build a Login Flow](https://developers.facebook.com/docs/facebook-login/manually-build-a-login-flow)已经提到了：对于桌面应用，redirectUri必须是https://www.facebook.com/connect/login_success.html 。
...
```
可以从返回的页面中获取登录表单：![获取Facebook User Token](/content/images/2016/8/0026uWfMzy73XyEhrcD73.jpg)
#### 认证
