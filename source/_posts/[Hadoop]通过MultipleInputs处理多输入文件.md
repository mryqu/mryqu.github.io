...
![[Hadoop] 通过MultipleInputs处理多输入文件](/content/images/2014/9/0026uWfMzy79A4n2gx3a1.jpg)
#### people.txt
```
1,Tomas,1
2,Edward,2
...
#### 测试结果
![[Hadoop] 通过MultipleInputs处理多输入文件](/content/images/2014/9/0026uWfMzy79A4xWbDae8.png)
### MultipleInputs分析
...
#### 调用每个输入文件的FileFormat
![[Hadoop] 通过MultipleInputs处理多输入文件](/content/images/2014/9/0026uWfMzy79A5fQD4mda.png)
#### 调用每个输入文件的Mapper
![[Hadoop] 通过MultipleInputs处理多输入文件](/content/images/2014/9/0026uWfMzy79A5ub0EY54.jpg)
#### 示例流程
![[Hadoop] 通过MultipleInputs处理多输入文件](/content/images/2014/9/0026uWfMzy79Aas39X056.jpg)