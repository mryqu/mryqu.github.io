...
![[Hive] Hive Macro和UDF实践](/content/images/2015/8/0026uWfMzy78hy3lA3K00.png)
mryqu_udf.jar文件内容如下：
```
...
![[Hive] Hive Macro和UDF实践](/content/images/2015/8/0026uWfMzy78hAEqmg2aa.png)
看到区别没，showfunctions返回结果包含我所创建的my_hello和my_lower函数。Hive元数据FUNCS表确实包含my_hello和my_lower的信息：
![[Hive] Hive Macro和UDF实践](/content/images/2015/8/0026uWfMzy78hBhI22Gfe.png)
下面的命令同样可以创建上述创建持久函数：
```
...
这里仅对普通Hive UDF进行实践，后继学习将在博文[Hive 表UDTF和汇聚UDAF学习](/2015/08/20/[Hive]Hive 表UDTF和汇聚UDAF学习) 中记录。
