...
![使用Facebook Graph API中的fields参数](/content/images/2016/1/0026uWfMzy73gPqG1BJ97.jpg)![使用Facebook Graph API中的fields参数](/content/images/2016/1/0026uWfMzy73gPr00iA50.jpg)
...
![使用Facebook Graph API中的fields参数](/content/images/2016/1/0026uWfMzy73gPrlmbr45.jpg)失而复得，虚惊一场！！！

[Using the Graph API](https://developers.facebook.com/docs/graph-api/using-graph-api)里不仅提到了选择参数，还提到可以使用字段表达式进行嵌套查询。
![使用Facebook Graph API中的fields参数](/content/images/2016/1/0026uWfMzy73gPrzveub6.jpg) likes字段使用limit(1)限定其仅返回一个点赞数据，反正我还要使用GraphAPI对帖子点赞数据进行请求，返回一个点赞知道需不需要请求就好了。
