...
```
![Get comments count using Facebook Graph API](/content/images/2016/5/0026uWfMzy7ai012ULXfd.jpg)
#### 获取评论的回复数
```
...
```
![Get comments count using Facebook Graph API](/content/images/2016/5/0026uWfMzy7ai0su4Pxdb.jpg)
