...
![[Zookeeper] 运行Zookeeper REST服务实践](/content/images/2016/3/0026uWfMzy77QwKcTCX4b.jpg)
### 以rest.sh方式启动
```
cd $ZOOKEEPER_HOME
...
#### 访问application.wadl
![[Zookeeper] 运行Zookeeper REST服务实践](/content/images/2016/3/0026uWfMzy77QDLY7omb2.jpg)
#### 获取根节点数据
![[Zookeeper] 运行Zookeeper REST服务实践](/content/images/2016/3/0026uWfMzy77QDXoOUhf9.png)
#### 获取根节点的子节点
![[Zookeeper] 运行Zookeeper REST服务实践](/content/images/2016/3/0026uWfMzy77QEfgxIH47.png)
#### 导出节点及znode层次数据
![[Zookeeper] 运行Zookeeper REST服务实践](/content/images/2016/3/0026uWfMzy77QFqAvMX37.jpg)
...
[安装HBase 1.2.x + ZooKeeper 3.4.x 集群](/2016/02/29/[HBase]安装HBase 1.2.x + ZooKeeper 3.4.x 集群)    