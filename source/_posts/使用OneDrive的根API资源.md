...
#### 获取默认驱动
![使用OneDrive的根API资源](/content/images/2016/10/0026uWfMzy75I4IvDa5d5.jpg)
#### 列举可用驱动
![使用OneDrive的根API资源](/content/images/2016/10/0026uWfMzy75I4IziWm12.jpg)
#### 通过ID获取指定驱动
![使用OneDrive的根API资源](/content/images/2016/10/0026uWfMzy75I4IC50yc6.jpg)
#### 列举特定驱动根路径下项目
![使用OneDrive的根API资源](/content/images/2016/10/0026uWfMzy75I4IHxYw94.jpg)
#### 通过ID访问一个目录"文档"
![使用OneDrive的根API资源](/content/images/2016/10/0026uWfMzy75I4IZuIH23.jpg)
#### 访问特殊目录documents
![使用OneDrive的根API资源](/content/images/2016/10/0026uWfMzy75I4J8fK9f9.jpg)
#### 通过共享ID访问文件CN_EN_JP_KO.xlsx

将文件CN_EN_JP_KO.xlsx共享，获取其共享URL：
![使用OneDrive的根API资源](/content/images/2016/10/0026uWfMzy75I4JaPyoa0.jpg)
通过共享ID使用OneDrive API访问文件CN_EN_JP_KO.xlsx：
![使用OneDrive的根API资源](/content/images/2016/10/0026uWfMzy75I4Jd6l298.jpg)
#### 通过根绝对路径访问文件CN_EN_JP_KO.xlsx

<font color="#FF0000">**注意root后有冒号：**</font>
![使用OneDrive的根API资源](/content/images/2016/10/0026uWfMzy75I4JfiEv6f.jpg)
#### 通过相对路径访问文件CN_EN_JP_KO.xlsx

<font color="#FF0000">**712B21FCE8E08C92!442是目录"文档"的ID，注意其后有冒号：**</font>
![使用OneDrive的根API资源](/content/images/2016/10/0026uWfMzy75I4JhWKr6f.jpg)
#### 通过根绝对路径列举目录"文档"的子元素

<font color="#FF0000">**注意root和路径（/文档）后都有冒号：**</font>
![使用OneDrive的根API资源](/content/images/2016/10/0026uWfMzy75I4Jk9u49c.jpg)
...
![使用OneDrive的根API资源](/content/images/2016/10/0026uWfMzy75I4Jorypd1.jpg)