...
![Postman使用笔记](/content/images/2015/9/0026uWfMgy6Vs7MGFN1d3.jpg)

### 使用

Postman可以模拟各种Http请求，并且可以额外设置特殊的URL参数、Http头以及Basic Auth、DigestAuth、OAuth 1.0等认证信息。在展现Http响应上，Postman支持完美打印，JSON、XML或是HTML都会整理成人类阅读的格式，有助于我们更清楚地查看响应内容。![Postman使用笔记](/content/images/2015/9/0026uWfMgy6VtgqXkfXb5.jpg)![Postman使用笔记](/content/images/2015/9/0026uWfMgy6Vti0NGNTb5.jpg)
