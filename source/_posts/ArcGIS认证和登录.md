...
---
### 申请ArcGIS Online账户
![ArcGISDev Signup](/content/images/2017/05/ArcGISDev_Signup.png)
### 创建应用

点击创建第一个应用：
![ArcGISDev NewApp](/content/images/2017/05/ArcGISDev_NewApp.png)
输入应用所需信息：
![ArcGISDev AppInfoInput](/content/images/2017/05/ArcGISDev_AppInfoInput.png)
查看应用信息：
![ArcGISDev AppInfoCheck](/content/images/2017/05/ArcGISDev_AppInfoCheck.png)
设置redirect URI：
![ArcGISDev App redirectURI](/content/images/2017/05/ArcGISDev_App_redirectURI.png)
### 获取应用访问令牌

![ArcGISDev App getAppToken](/content/images/2017/05/ArcGISDev_App_getAppToken.png)
...
```
请求用户授权：
![ArcGISDev App authorize](/content/images/2017/05/ArcGISDev_App_authorize.png)
返回地址包含code参数，内容中也有一含有code值的文本框：
![ArcGISDev App Approval](/content/images/2017/05/ArcGISDev_App_approval.png)
...
```
![ArcGISDev App getUserToken](/content/images/2017/05/ArcGISDev_App_getUserToken.png)
### 访问令牌使用
...
![ArcGISDev App wrongToken](/content/images/2017/05/ArcGISDev_App_wrongToken.png)
### 参考
* * *
