...
- delve
---
想装个MinGW-W64玩玩64位GDB，才发现继上一博文[MinGW安装和使用](/2014/02/04/MinGW安装和使用)已三年了，不经意间到看到了下列帖子：
...
不过[Debugging Go Code with GDB](https://golang.org/doc/gdb)里还介绍了另外一个对Golang支持更好的工具[Delve](https://github.com/derekparker/delve)。![delve](/content/images/2017/10/delve.png) 上手容易，有些命令跟GDB差不多。![delve commands](/content/images/2017/10/delveCmds.png) 好了，就折腾到这里了。目前不太需要的东东就不花费力气了。
