...
这个示例演示了一个视图如何控制另外一个视图的控件是否显示，一个视图调用了另外一个视图控制器的方法。但是它完全违反了我以前有篇学习帖子[重温MVC:一个很好的MVC](/2014/03/26/重温MVC一个很好的MVC图)中的规则，不可以在实际工作中使用！

此外通过调试找到了sap.ui.core.Core里面ID与组件的映射表。![[OpenUI5] MVC：访问其他View/Controller的方法](/content/images/2015/1/0026uWfMgy6P1HuLUmY38.jpg)