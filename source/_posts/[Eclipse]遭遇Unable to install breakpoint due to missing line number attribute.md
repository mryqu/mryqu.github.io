...
![[Eclipse] 遭遇"Unable to install breakpoint due to missing line number attribute"](/content/images/2015/10/0026uWfMgy6WClZQ0lY62.png)
检查**Preferences -> Java -> Perference**，"Add linenumber attributes to generated class files (used by thedebugger)"已经勾选了。
![[Eclipse] 遭遇"Unable to install breakpoint due to missing line number attribute"](/content/images/2015/10/0026uWfMgy6WCm0AEYgd8.png)
