...
![Dropbox认证和登录](/content/images/2016/10/0026uWfMzy75TeB4RP0de.jpg) [Dropbox OAuth Guide](https:///developers/reference/oauth-guide)提到：对于命令行或桌面应用，没办法让浏览器重定向回你的应用。这种情况下，你的应用无需包含redirect_uri参数。Dropbox将向用户显示认证码，以用于复制到你的应用来获得可重用的访问令牌。基于此，对于桌面应用，redirect_uri不用设置；对于web应用，我选择了http://localhost以便测试。Dropbox网站没有提及urn:ietf:wg:oauth:2.0:oob。
![Dropbox认证和登录](/content/images/2016/10/0026uWfMzy75TghEHYu62.jpg)![Dropbox认证和登录](/content/images/2016/10/0026uWfMzy75TeClvhP05.jpg)
...
```
请求用户授权：![Dropbox认证和登录](/content/images/2016/10/0026uWfMzy75ThTu23m78.jpg)
显示认证码：![Dropbox认证和登录](/content/images/2016/10/0026uWfMzy75Ti324NW48.jpg)
...
```
![Dropbox认证和登录](/content/images/2016/10/0026uWfMzy75ThUOJkVd5.jpg)
