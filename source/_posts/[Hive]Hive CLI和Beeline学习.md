...
不是，打印的是原始SQL语句。
![[Hive] Hive CLI和Beeline学习](/content/images/2015/7/0026uWfMzy7aXN3VbkA30.png)
...
- 其中以!起始的SQLLine命令由execCommandWithPrefix方法处理，具体实现见[Commands类](https://github.com/apache/hive/blob/master/beeline/src/java/org/apache/hive/beeline/Commands.java)的同名方法。![[Hive] Hive CLI和Beeline学习](/content/images/2015/7/0026uWfMzy7aZjD4Hcdd1.png)
